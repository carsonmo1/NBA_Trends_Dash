...
🏀 **[View Live Dashboard](https://your-app-name.onrender.com)** *(Update this link after deployment)*
...
- **Data Freshness**: Google Sheets data is static; could add automated updates
- **Mobile**: Layout is optimized for desktop; mobile responsiveness could be improved
- **Team Click**: Four Factors radar currently shows champion; could wire to team click selection
- **Performance**: 3M shots load on every startup; caching would improve cold start time
...
*Built as part of a data science portfolio project showcasing dashboard development and sports analytics skills.*
